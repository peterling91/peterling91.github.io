window.addEventListener("load", () => {
  ...
  function handleMarkClick(event) {
    ...
    const stampImages = [
      "FMO-Line-Game-on.png",
      "FMO-Line-Knowledge-is-power.png",
      "FMO-Line-Peace.png",
      "FMO-Line-Welcome-freshie.png",
      "FMO-Non-Line-I-love-school.png",
      "FMO-Non-Line-Lets-have-fun.png",
      "FMO-Non-Line-Smiley.png",
      "FMO-Non-Line-Time-for-you-to-shine.png",
    ];
